...
define("TOKEN", "ylkxzyy");
define("APPID",'wx5642ba0a4ffd98bd');
define('SECRET','af49617df8dd2fc09934c3f92da44278');
...
//        $postStr = $GLOBALS["HTTP_RAW_POST_DATA"];
    ...
    private function receiveText($object)
    {
        ...
        if (strstr($keyword, "文本")){
            ...
            $content = "电话号码：0755-87654321\n\n电子邮件：12345@qq.com\n\n公司网址：<a href='http://www.ylkxzyy.cn/zhihui/app.php'>西软云</a>";
        ...
        }else if(strstr($keyword,'authLogin')){
            $huiDiaoUrl = urlencode("http://zyytest.applinzi.com/wx/authlogin.php");
            $code = md5(time());
            $url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".
                APPID."&redirect_uri=".$huiDiaoUrl."&response_type=".$code."&scope=snsapi_userinfo&state=zyy#wechat_redirect";
            $content = "<a href='$url'>点击登陆</a>";
        }
        else{
